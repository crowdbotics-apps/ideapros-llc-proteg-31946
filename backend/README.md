...
## Project Structure
    ...
    ├── ideapros_llc_proteg_31946  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_proteg_31946`
...
2. Clone this repo and `cd ideapros_llc_proteg_31946`
